...
public class ChatInputView extends LinearLayout
    implements View.OnClickListener, TextWatcher, PhotoAdapter.OnFileSelectedListener,
  ...
  @Override public void onTakePictureCompleted(File file) {
    List<String> list = new ArrayList<>();
    list.add(file.getAbsolutePath());
    mListener.onSendFiles(list);
  }

  @Override public void onRecordVideoCompleted(File file) {
        ...
        switch (msg.what) {
          case SCAN_OK:
            ...
            chatInputView.mPhotoAdapter =
                new PhotoAdapter(chatInputView.mPhotos, chatInputView.mMenuHeight);
